...
event PostBeginPlay()
{
	...
	if (Level.NetMode != NM_Client)
	{
		if (WMut==none)
		{
			...
			if (WMut==none)
				Level.Game.AddMutator("WeldBot.WeldBotMut");
...
defaultproperties
{
	...
	Health=5000
	SndFootStep(0)=Sound'chippoDT_A.Sentry_sstep_01'
	SndFootStep(1)=Sound'chippoDT_A.Sentry_sstep_02'
	SndFootStep(2)=Sound'chippoDT_A.Sentry_sstep_03'
	SndFootStep(3)=Sound'chippoDT_A.Sentry_sstep_04'
	SndFootStep(4)=Sound'chippoDT_A.Sentry_sstep_05'
	SndFootStep(5)=Sound'chippoDT_A.Sentry_sstep_06'
	SndFootStep(6)=Sound'chippoDT_A.Sentry_sstep_07'

	SndPain(0)=Sound'chippoDT_A.Sentry_pain_01'
	SndPain(1)=Sound'chippoDT_A.Sentry_pain_02'
	SndPain(2)=Sound'chippoDT_A.Sentry_pain_03'
	SndPain(3)=Sound'chippoDT_A.Sentry_pain_04'

	SndFire(0)=Sound'chippoDT_A.WeldTransformerCrop'
	
	SndOther(0)=Sound'chippoDT_A.Sentry_shutdown_01'
	SndOther(1)=Sound'chippoDT_A.Sentry_destroyed_01'
	SndOther(2)=Sound'chippoDT_A.Sentry_fight_enemy_02'
	SndOther(3)=Sound'chippoDT_A.Sentry_sight_enemy_01'
	SndOther(4)=Sound'chippoDT_A.Sentry_activate_01'
	SndOther(5)=Sound'chippoDT_A.Sentry_wait_for_player_02'
	//FiringSounds(0)=SoundGroup'KF_MP7Snd.Medicgun_Fire'
	bScriptPostRender=false // PostRender2D not used more so false here. HudAddOverlay used instead (spawns in WeldBotMut)
	...
	EyeHeight=0.000000
	ControllerClass=Class'WeldBot.WeldBotController'
	bPhysicsAnimUpdate=false
	bStasis=False
	Physics=PHYS_Falling
	Mesh=SkeletalMesh'chippoDT_A.chippoDTMesh'
	PrePivot=(Z=-24.55) //(Z=-5.000000) translation Z=29.100000
	//CollisionRadius=20.000000
	//CollisionHeight=23.000000
	CollisionRadius=5.0 //25.0 21.11.2012
	...
	UsedByTraceWidth=(X=10.0,Y=10.0,Z=1)
}